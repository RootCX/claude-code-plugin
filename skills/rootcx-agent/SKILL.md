---
name: rootcx-agent
description: Building a RootCX AI agent — project structure, backend/agent.json config, LangGraph createReactAgent, IPC bridge, tools & RBAC, invoke SSE endpoint. Use when scaffolding or editing an agent app with a LangGraph backend.
version: 0.1.0
---
...
See `templates/agent.json` and `templates/system.md` for starting files.
